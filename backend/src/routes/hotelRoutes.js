...
router.get("/", authorize("owner", "branch_manager", "receptionist", "super_admin", "housekeeping", "accountant"), getHotels);
...
router.get("/:hotelId/branches", authorize("owner", "branch_manager", "receptionist", "super_admin", "housekeeping", "accountant"), getBranches);
